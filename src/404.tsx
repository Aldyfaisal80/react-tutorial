...
export default function ErrorPage() {
    return (
        <div className="bg-gray-100 h-screen justify-center pt-[20vh]">
            ...
            <center className="mt-6">
                <Link to="/dashboard" className="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">Go back</Link>
            </center>
        </div>
    )
}
